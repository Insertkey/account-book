...
export class AccountBookService {
  ...
  getBillList() {
    return this.http.get('https://raw.githubusercontent.com/xmindltd/hiring/master/frontend-1/bill.csv', {responseType: 'text'})
  }

  getBillCategoryList() {
    return this.http.get('https://raw.githubusercontent.com/xmindltd/hiring/master/frontend-1/categories.csv', {responseType: 'text'})
  }
}
...
export const bill = `type,time,category,amount
